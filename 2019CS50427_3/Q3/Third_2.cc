...
Config::Set (specificNode3, TypeIdValue (tid3));
  ...
  Ptr<OutputStreamWrapper> stream1 = asciiTraceHelper.CreateFileStream ("Third_2_1.cwnd");
  localSocket1->TraceConnectWithoutContext ("CongestionWindow", MakeBoundCallback (&CwndChange, stream1));

  Ptr<OutputStreamWrapper> stream2 = asciiTraceHelper.CreateFileStream ("Third_2_2.cwnd");
